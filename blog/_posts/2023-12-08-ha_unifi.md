---
title: "Ubiquiti UniFi Network Application auf Home Assistant installieren"
description: "Home Assistant Add-On: UniFi Network Application auf Raspberry Pi 4 installieren und konfigurieren."
excerpt: "Wie ich die Ubiquiti UniFi Network Application als Home Assistant Add-On auf meinem Pi installiert und getestet habe."
categories: [Tutorials, Home Automation, Networking]
tags:
    - home assistant
    - howto
    - linux
